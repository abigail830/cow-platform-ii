...
title: "Layer 1 spine — incorp-ph-recruitment"
...
Source: `incorp-ph-recruitment.docx`

## Stats
227 paragraphs, 8 tables, 44 images.

## Section spine
1. Cover + TOC + credentials
2. RE: FEE PROPOSAL
3. SERVICES AND FEES / Other Services tbl[3]
4. **RECRUITMENT AND EXECUTIVE SEARCH**
5. FEES, MISCELLANEOUS EXPENSES AND SERVICE SCOPE
6. A. Recruitment table tbl[4]–tbl[5]
7. B. **GUARANTEE PERIOD** (3-month replacement)
8. C. **PAYMENT** (7-day terms)
9. CLIENT'S CONFORME + CLIENT DETAILS tbl[6]
10. CDD document list tbl[7]
11. GENERAL TERMS AND CONDITIONS (A–G sections)
