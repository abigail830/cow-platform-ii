...
class CliSettings(BaseSettings):
    ...
    docmind_endpoint: str = Field(
        ...
        validation_alias="OPENKMS_DOCMIND_ENDPOINT",
    )
    docmind_enable_event_callback: bool = Field(
        default=False,
        validation_alias="OPENKMS_DOCMIND_ENABLE_EVENT_CALLBACK",
    )
    oss_presign_ttl_seconds: int = Field(
        default=3600,
        ge=300,
        le=86_400,
