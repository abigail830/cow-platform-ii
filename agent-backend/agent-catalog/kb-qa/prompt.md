...
- **Citations as anchors:** Cite sources for each **claim you include in the answer**—not for every result you chose not to use.
  - KB: `knowledge_base_name` and `source_name`
