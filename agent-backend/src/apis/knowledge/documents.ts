...
import { autoStartPipelineAfterUpload } from '../../pipeline/application/auto-pipeline.ts';
import { startDocumentPipeline } from '../../pipeline/application/pipeline-runner.ts';
