...
import {
  ...
  startKbFaqIndexJob,
  updateKbFaq,
} from '../../kb/application/kb-faqs.ts';
import {
  deleteKbChunksForDocument,
  listIndexedDocuments,
  listKbChunksForDocument,
} from '../../kb/application/kb-chunks.ts';
import {
  createKnowledgeBase,
  deleteKnowledgeBase,
  deleteKbItem,
...
knowledgeBases.get(
  ...
  async (c) => {
    const { listRagPipelineOptions } = await import('../../kb/domain/rag-pipeline-binding.ts');
...
knowledgeBases.get(
  ...
  async (c) => {
    const { listFaqPipelineOptions } = await import('../../kb/domain/faq-pipeline-binding.ts');
