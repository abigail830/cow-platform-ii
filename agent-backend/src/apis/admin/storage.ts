...
import {
  ...
  type MoveItem,
} from '../../infrastructure/oss/object-storage.ts';
import {
  presignCreateStorageFolder,
  presignListStorageObjects,
  presignMoveStorageOperations,
} from '../../infrastructure/oss/object-storage-presign.ts';
import { formatStorageError } from '../../document/infrastructure/document-files.ts';
