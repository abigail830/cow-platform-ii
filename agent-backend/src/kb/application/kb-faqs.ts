...
import { getDocumentById } from '../../document/application/documents.ts';
import { decodeEmbeddingBase64 } from '../domain/kb-chunk-embedding.ts';
...
} from './faq-index-workflow.ts';
import { propagateDocMetadata } from '../domain/kb-faq-metadata.ts';
