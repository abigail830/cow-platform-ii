...
import { appDocuments, appPipelineJobs, db, PIPELINE_JOB_STAGES, type PipelineJobStage } from '../../infrastructure/db/index.ts';
...
import { syncEvalRunItemFromDocumentPipelineJob } from '../../eval/application/eval-document-bridge.ts';
