...
import audioChannels from './routes/audio-channels.ts';
import documents from './routes/documents.ts';
import audios from './routes/audios.ts';
import audioCaptures from './routes/audio-captures.ts';
import documentCaptures from './routes/document-captures.ts';
...
import pageIndexSearchMcp from './routes/mcp/pageindex-search.ts';
...
import evaluation from './routes/evaluation/index.ts';
import knowledge from './routes/knowledge/index.ts';
...
app.route('/api/audio-channels', audioChannels);
app.route('/api/documents', documents);
app.route('/api/audios', audios);
app.route('/api/audio-captures', audioCaptures);
app.route('/api/document-captures', documentCaptures);
