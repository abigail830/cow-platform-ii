...
describe('eval-judge-dimensions', () => {
  it('loads default no-GT ASR compare scenario with variant and pairwise dimensions', () => {
    const scenario = getDefaultEvalJudgeScenario();
    ...
    const dimensions = snapshotEvalJudgeDimensions();
