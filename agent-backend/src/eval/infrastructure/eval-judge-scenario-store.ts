...
import { db, appEvalJudgeScenarios, type EvalJudgeDimensionRecord } from '../../infrastructure/db/index.ts';
import type {
  EvalJudgeDimensionDefinition,
  EvalJudgeScenarioDefinition,
} from '../domain/eval-judge-types.ts';
import { validateJudgeDimensions } from '../domain/eval-judge-dimension-validate.ts';
