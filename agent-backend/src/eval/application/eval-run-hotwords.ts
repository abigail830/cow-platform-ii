...
import { audioTranscribeModelDisplayNameFromPipeline } from '../../audio/domain/audio-transcribe-workflow.ts';
...
} from '../../audio/domain/asr-hotword-validation.ts';
import {
  dashScopeCreateVocabulary,
  dashScopeUpdateVocabulary,
  type DashScopeVocabularyCredentials,
} from '../../audio/application/asr-vocabulary-sync.ts';
