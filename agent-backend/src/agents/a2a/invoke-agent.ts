import type { AgentConversationMessage } from '../runtime/load-agent-conversation-snapshot.ts';
import { extractPublishedProposals } from '../runtime/load-agent-conversation-snapshot.ts';
...
function textFromMessages(messages: AgentConversationMessage[]): string {
  return messages
...
function isStillStreaming(messages: AgentConversationMessage[]): boolean {
