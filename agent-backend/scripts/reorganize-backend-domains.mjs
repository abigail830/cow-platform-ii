...
const MOVES = {
  ...
  'shared/model-specifier.ts': 'model-config/infrastructure/model-specifier.ts',
  'shared/model-specifier.test.ts': 'model-config/infrastructure/model-specifier.test.ts',
