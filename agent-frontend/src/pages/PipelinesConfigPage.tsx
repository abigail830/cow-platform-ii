...
function PipelineRow({
  ...
  return (
    <tr key={pipeline.id} className={isSystem ? 'pipeline-system-row' : undefined}>
      <td>
      ...
      <td className={isSystem ? 'pipeline-system-meta' : undefined}>
        {isSystem ? 'Built-in' : new Date(pipeline.updatedAt).toLocaleDateString()}
      </td>
      <td>
      ...
      <main className="admin-page">
        <header className="admin-header">
          ...
          <AdminPageDescription>
            Document pipelines parse channel uploads. PageIndex knowledge bases are linked to the
            system KB import pipeline at creation time.
          </AdminPageDescription>
        </header>
